...
export default function Layout() {
  ...
  return (
    <div className={`min-h-screen flex flex-col overflow-x-hidden w-full ${language === 'ar' ? 'font-arabic' : 'font-sans'}`} dir={language === 'ar' ? 'rtl' : 'ltr'}>
      {/* Top Bar */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            ...
            <Link to="/" className="flex items-center cursor-pointer shrink-0">
              <img src="/logo.png" alt="Logo" fetchPriority="high" className={`w-14 h-14 md:w-24 md:h-24 object-contain scale-125 ${language === 'ar' ? '-ml-2 md:-ml-5 -mr-1 md:-mr-4' : 'mr-2 md:mr-2 -ml-1 md:-ml-4'}`} />
      ...
      <div className={`fixed bottom-4 md:bottom-6 ${language === 'ar' ? 'left-4 md:left-6' : 'right-4 md:right-6'} z-50 flex flex-col gap-3 md:gap-4 items-center`}>
        {/* Phone Call Floating Button */}
        <a 
          href="tel:0224230003" 
          className="bg-[#A3924A] text-white p-3.5 md:p-4 rounded-full shadow-lg shadow-[#A3924A]/40 hover:scale-110 transition-transform flex items-center justify-center hover:shadow-xl hover:shadow-[#A3924A]/50 w-14 h-14 md:w-16 md:h-16"
          aria-label="اتصل بنا"
        >
        ...
        <a 
          ...
          className="bg-[#25D366] text-white p-3.5 md:p-4 rounded-full shadow-[0_4px_12px_rgba(37,211,102,0.4)] hover:scale-110 transition-transform flex items-center justify-center hover:shadow-[0_6px_16px_rgba(37,211,102,0.5)] w-14 h-14 md:w-16 md:h-16"
